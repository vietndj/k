...
for item in deduped_data:
    ...
    if os.path.exists(path):
        item["path"] = path # save resolved path
...
<body>
    <header>
        ...
        <div class="subtitle">Tổng số: """ + str(len(valid_data)) + """ concept độc bản (Đã lọc ảnh lỗi)</div>
    </header>
...
with open("anh.html", "w") as f:
    f.write(html)
print(f"Updated anh.html successfully. Now showing {len(valid_data)} unique posters (filtered out missing).")
