...
<body>
    <header>
        ...
        <div class="subtitle">Tổng số: """ + str(len(deduped_data)) + """ concept độc bản (Đã lọc trùng lặp)</div>
    </header>
...
with open("anh.html", "w") as f:
    f.write(html)
print(f"Updated anh.html successfully. Filtered down to {len(deduped_data)} unique prompts.")
