...
<body>
    <header>
        ...
        <div class="subtitle">Tổng số: """ + str(len(valid_data)) + """ hình ảnh độc bản (Đã lọc trùng lặp & lỗi)</div>
    </header>
...
with open("anh.html", "w") as f:
    f.write(html)
print(f"Updated anh.html successfully. Now showing {len(valid_data)} visually unique posters.")
